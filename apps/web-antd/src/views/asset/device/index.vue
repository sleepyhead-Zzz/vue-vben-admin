...
async function handleEdit(row: AssetAPI.AssetDeviceDTO) {
  modalApi.setData({ id: row.deviceId });
  modalApi.open();
}
  ...
  <Page :auto-content-height="true">
    <BasicTable table-title="设备列表">
      <template #toolbar-tools>
        <Space>
          <a-button
            v-access:code="['asset:device:export']"
          ...
          <a-button
            ...
            danger
            type="primary"
            v-access:code="['asset:device:remove']"
          ...
          <a-button
            type="primary"
            v-access:code="['asset:device:add']"
            @click="handleAdd"
          >
            {{ $t('pages.common.add') }}
          </a-button>
      ...
      <template #action="{ row }">
        <Space>
          <ghost-button
            v-access:code="['asset:device:edit']"
