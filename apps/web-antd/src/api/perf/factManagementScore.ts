...
/** 内部管理单入口导入（按scoreType分发） POST /perf/FactManagementScore/importData */
export async function importByType(
  body: {
    request: PerfAPI.ManagementScoreImportRequest;
  },
  file?: File,
  options?: { [key: string]: any }
) {
...
/** 执行力导入 POST /perf/FactManagementScore/importData/execution */
export async function importExecutionByExcel(
  body: {
    request: PerfAPI.ExecutionImportRequest;
  },
  file?: File,
  options?: { [key: string]: any }
) {
  ...
  return request<PerfAPI.ResponseDTOImportResponseDTO>(
    "/perf/FactManagementScore/importData/execution",
    {
      method: "POST",
      data: formData,
      requestType: "form",
...
/** 逾期导入 POST /perf/FactManagementScore/importData/overdue */
export async function importOverdueByExcel(
  body: {
    request: PerfAPI.OverdueImportRequest;
  },
  file?: File,
  options?: { [key: string]: any }
) {
  ...
  return request<PerfAPI.ResponseDTOImportResponseDTO>(
    "/perf/FactManagementScore/importData/overdue",
    {
      method: "POST",
      data: formData,
      requestType: "form",
...
/** 样品反馈导入 POST /perf/FactManagementScore/importData/sample-feedback */
export async function importSampleFeedbackByExcel(
  body: {
    request: PerfAPI.SampleFeedbackImportRequest;
  },
  file?: File,
  options?: { [key: string]: any }
) {
  ...
  return request<PerfAPI.ResponseDTOImportResponseDTO>(
    "/perf/FactManagementScore/importData/sample-feedback",
    {
      method: "POST",
      data: formData,
      requestType: "form",
...
/** 周报导入 POST /perf/FactManagementScore/importData/weekly-report */
export async function importWeeklyReportByExcel(
  body: {
    request: PerfAPI.WeeklyReportImportRequest;
  },
  file?: File,
  options?: { [key: string]: any }
) {
  ...
  return request<PerfAPI.ResponseDTOImportResponseDTO>(
    "/perf/FactManagementScore/importData/weekly-report",
    {
      method: "POST",
      data: formData,
      requestType: "form",
