...
export async function getGenInfo(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: ToolAPI.getGenInfoParams,
  options?: { [key: string]: any },
) {
...
export async function downloadCode(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: ToolAPI.downloadCodeParams,
  options?: { [key: string]: any },
) {
  const { tableId: param0, ...queryParams } = params;
...
export async function genGenList(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: ToolAPI.genGenListParams,
  options?: { [key: string]: any },
) {
