...
!(function () {
                        ...
                        q(ma(e, '|'), (e) => {
                          ...
                          if (a) {
                            ...
                            if (
                              ...
                              return (
                                delete r[i],
                                void s.splice(an.inArray(s, i), 1)
                              );
                            if (
                              (l &&
                                ('=' === l
  ...
  const ci = N('mce-annotation'),
    ...
    Fi = (e) => (
      Ii(e) && (e = e.parentNode),
      Mi(e) && e.hasAttribute('data-mce-caret')
    ),
    Ui = (e) => Ii(e) && Di(e.data),
    zi = (e) => Fi(e) || Ui(e),
    ...
    xm = (e, t) => {
      ...
      return es(n)
        ...
        : n
          ? fl(n)
            ? I.some(
                e ? Pl.before(n) : as((o = n)) ? Pl.before(o) : Pl.after(o),
              )
            : ((e, t, n) => {
        ...
        e
          ? ((e, t) =>
              Dh(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    _m(e, Pl.after(t)).orThunk(() => Sm(e, Pl.before(t))))(
                    e,
                    t,
                  ),
                ))(t, n)
                ...
                .bind((e) => {
                  ...
                  if (r.length > 0) {
                    if (o) return I.some(rb.partialTable(r, I.none()));
                    {
                      const e = mb(n, t);
                      return I.some(
                        rb.partialTable(r, I.some({ ...t, rng: e })),
                      );
                    }
                  }
                  return I.none();
    ...
    Zv = (e, t, n, o, r) => {
      ...
      if ('all' !== t.remove) {
        (Gv(s, l, t, n, r),
          ...
          zv(t.classes, (e) => {
            ((e = gf(e, n)),
              (qr(r) && !s.hasClass(r, e)) || s.removeClass(l, e));
          }));
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                xr(
                  ...
                  (n) =>
                    ue(t, (t) =>
                      ((t, n) => (iv(e, t.dom, n) ? I.some(n) : I.none()))(
                        n,
                        t,
                      ),
                    ),
                      ...
                      : ((e, t, n, o) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? 'after' : 'before';
                            return (
                              qr(n) && n.getAttribute('data-mce-caret') === o
                            );
                          })(t, n)
                            ? ((e, t) =>
                                y(t)
                                  ...
                                  : e && cs(t.nextSibling)
                                    ...
                                    : !e && cs(t.previousSibling)
                                      ? I.some(
                                          yx.moveToElement(t.previousSibling),
                                        )
  ...
  const sT = (e, t) => Math.abs(e.left - t),
    ...
    VT = (e, t, n) => {
      (MT(e, e.get(t.prefix + '-end'), n),
        MT(e, e.get(t.prefix + '-start'), n));
    },
  ...
  class AB {
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = kB.get(this.id)),
        this.targetElm
      );
    }
    getWin() {
