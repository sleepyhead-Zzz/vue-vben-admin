!(function () {
  ...
  const F = (e, t) => e.isBlock(t) || x(e.schema.getVoidElements(), t.nodeName),
    ...
    M = (e, t) =>
      !e.isBlock(t) && x(e.schema.getWhitespaceElements(), t.nodeName),
    R = (e, t) =>
      ((e, t) => {
    ...
    H = (e, t, n) => {
      ...
      const a = K(e, o);
      return a.length
        ? (s.addClass(K(e, o), 'mce-match-marker-selected'),
    ...
    Z = (e, t, n, r, o) => {
      ...
      for (let t = 0; t < d.length; t++) {
        ...
        if (o || u === s.index) {
          for (
            n.length ? ((d[t].innerText = n), G(d[t])) : J(e.dom, d[t]);
            d[++t];
    ...
    te = (e, t) => {
      ...
      const r = C.trim(e.selection.getContent({ format: 'text' })),
        ...
        s = (e, t) => {
          h(['replace', 'replaceall', 'prev', 'next'], (n) =>
            e.setEnabled(n, !t),
          );
        },
        l = (e, t) => {
