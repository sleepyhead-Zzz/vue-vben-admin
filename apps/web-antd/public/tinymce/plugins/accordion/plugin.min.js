!(function () {
  ...
  const te = (e, t, o) =>
    ...
    se = {
      ...
      create: l({
        nu: T.fromTag,
        clone: (e) => T.fromDom(e.dom.cloneNode(!1)),
        text: T.fromText,
      }),
      query: l({
  ...
  const ue = (e) => 'SUMMARY' === (null == e ? void 0 : e.nodeName),
    ...
    fe = (e) =>
      !he(e) && e.dom.isEditable(e.selection.getNode()) && !e.mode.isReadOnly(),
    ...
    Ne = (e) => {
      ...
      e.undoManager.transact(() => {
        (e.insertContent(
          [
            `<details data-mce-id="${o}" class="${ie}" open="open">`,
            s,
            a,
            '</details>',
          ].join(''),
    ...
    Te = (e, t) => {
      ...
      return (
        o ? e.setAttribute('open', 'open') : e.removeAttribute('open'),
        o
      );
    },
    Ae = (e) => {
