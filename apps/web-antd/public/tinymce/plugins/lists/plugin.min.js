!(function () {
  ...
  const Me = (e) => (t) => l(t) && t.nodeName.toLowerCase() === e,
      ...
      for (
        ...
        (c ||
          ...
          ze(a, r)
            ...
            : (d || ((d = o.create(i, l)), s.appendChild(d)),
              d.appendChild(a)));
      }
      return (
    ...
    ct = (e) => {
      ...
      return L(
        ((e, t) => {
          const n = Be.map(
            t,
            (t) => e.dom.getParent(t, 'li,dd,dt', ut(e, t)) || t,
          );
          return B(n);
        })(e, t),
        He,
      ...
      const n = e.dom.getParents(t, e.dom.isBlock),
        o = T(n, (t) => {
          return (
            ...
            !Ue((o = t)) &&
              !He(o) &&
              b(lt, (e) => n.isValidChild(o.nodeName, e)))
          );
          var n, o;
        });
    ...
    Rt = (e, t, n) => {
      const o = ((e, t) => {
        ...
        ((e) => {
          const t = N(ct(e), z);
          return U(T(t, p(St)), T(k(t), p(St)), (e, t) => ({
            start: e,
            end: t,
          }));
        })(e),
            ...
            return T(n, (e) => {
              return (
                ...
                se(t).exists(
                  (e) =>
                    He(e.dom) &&
                    ae(e).exists((e) => !Ue(e.dom)) &&
                    de(e).exists((e) => !Ue(e.dom)),
                )
              );
              var t;
            }).fold(
  ...
  const jt = De.DOM,
        ...
        if (n) {
          if (Re(n) && n.parentNode) {
            ...
            ((o = ((e) => {
              ...
              for (; n; ) {
                if (n === e) return o;
                ((Re(n) && 'bookmark' === n.getAttribute('data-mce-type')) ||
                  o++,
                  (n = n.nextSibling));
              }
              return -1;
      ...
      if (n && Ie(r))
        if (F(r.textContent)) r = i(r, !1).getOr(r);
          ...
          for (
            ...
            (Zt(e, r.previousSibling) || Ie(r.previousSibling));
      ...
      if (!n && Ie(r))
        if (F(r.textContent)) r = i(r, !0).getOr(r);
          ...
          for (
            null !== r.parentNode && Zt(e, r.parentNode) && (r = r.parentNode);
            null !== r.nextSibling &&
            (Zt(e, r.nextSibling) || Ie(r.nextSibling));
          ...
          ((e, t, n) => {
            ...
            return (
              Be.each(a, (t) => {
                ...
                if (r.isBlock(t) || je(t))
                  return (je(t) && r.remove(t), void (l = null));
                const i = t.nextSibling;
                Vt.isBookmarkNode(t) &&
                (Ue(i) || Ke(e, i) || (!i && t.parentNode === n))
                  ? (l = null)
                  : (l ||
                      ((l = r.create('p')),
                      null === (s = t.parentNode) ||
    ...
    Xt = (e, t, n) => {
      return (
        ((e, t) => Ue(e) && e.nodeName === (null == t ? void 0 : t.nodeName))(
          t,
          n,
        ) &&
        ((e, t, n) =>
    ...
    ln = (e, t, n, o) => {
      ...
      n &&
        ((e, t) =>
          !!je(t) && e.isBlock(t.nextSibling) && !je(t.previousSibling))(
          e.dom,
          r,
        ) &&
        l.next();
              ...
              ((e, t) => {
                ...
                if (s && n.isEmpty(s, void 0, { checkRootAsContent: !0 })) {
                  ...
                  if (i && l) {
                    ...
                    return (
                      !!((e, t, n = u) =>
                        U(e, t, n).getOr(e.isNone() && t.isNone()))(
                        Te(z(l), a, d),
  ...
  const Nn = (e) => 3 === e.type,
    ...
    On = (e, t) => (n) => (
      ...
      Ct(e, (o) => {
        (n.setActive(ft(o.parents, t)),
          n.setEnabled(!vt(e, o.element) && e.selection.isEditable()));
      })
    ),
    An = (e, t) => (n) =>
      Ct(e, (o) => n.setEnabled(ft(o.parents, t) && !vt(e, o.element)));
  e.add(
    'lists',
    (e) => (
      ((e) => {
                    ...
                    null === n ||
                      ...
                      e.undoManager.transact(() => {
                        (r(t.styles) && e.dom.setStyles(n, t.styles),
                          r(t.attrs) &&
                            P(t.attrs, (t, o) => e.dom.setAttrib(n, o, t)));
                      });
                  })(e, n);
              }),
